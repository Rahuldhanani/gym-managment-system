<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $qry="UPDATE `register` SET `id`='$id',`fname`='$fname',`mno`='$mno',`gender`='$gender',`email`='$email',`password`='$password' WHERE id='$id'";
                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="number" name="mno" value="<?php echo $row['mno']?>" placeholder="Enter mobile number" required>
                        </div>
                          <div class="input-field">
                            <label>Gender</label>
