...
if (isset($_POST['submit']))
 {
    ...
    $qry = "UPDATE `contact` SET `id`='$id',`name`='$name',`email`='$email',`mno`='$mno',`comment`='$comment' WHERE id='$id'";
...
<body>
    ...
    <div class="d1 text-white pb-5">
        ...
        <div class="container text-center mt-5 pt-5">
            <div class="d3">SHAPE YOUR BODY</div>
            <h1 class="d4 fw-bold mt-3">BE <span class="text-warning">STRONG</span><br>TRAINING HARD</h1>
            <a href="#" class="btn btn-outline-warning mt-4 px-4 py-2 mb-5">GET INFO</a>
        </div>
    </div>
    <!-- contact page -->
    <div class="con">
        <div class="container ">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6">
                ...
                <form action="" method="post" class="pt-5">                                   
                    <div class="mb-3">                    
                        <input type="text" class="form-control" style="background-color: transparent; border: 1px solid gray;" name="name"  id="name" value="<?php echo $row['name']?>" placeholder="Enter your name" required >
                      </div>
                  
                      <!-- Email Field -->
                      <div class="mb-3">
                        <input type="email" class="form-control" style="background-color: transparent; border: 1px solid gray;" name="email" id="email" value="<?php echo $row['email']?>" placeholder="Email" required>
                      </div>
                  
                      <!-- Website Field -->
                      <div class="mb-3">
                        <input type="number" class="form-control" style="background-color: transparent; border: 1px solid gray;" name="mno"  id="mno" value="<?php echo $row['mno']?>" placeholder="mobile no">
                      </div>
                  
                      <!-- Comment Field -->
                      <div class="mb-3">                     
                        <textarea class="form-control" id="comment" style="background-color: transparent; border: 1px solid gray;" name="comment" rows="4" value="<?php echo $row['comment']?>" placeholder="comment"></textarea>
                      </div>
                  
                      <!-- Submit Button -->
                       <div class="d-grid ">
                            <input type="submit" name="submit" class="btn text-center" style="color: white;background-color: #f36100;">Submit</input>
                       </div>
                </form>
            </div>
        </div>
